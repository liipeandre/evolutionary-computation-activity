...
class Populacao(object):  
    ...
    def Selecao_Roleta(self):
        ...
        resultado_sorteio = randrange(0, int(soma_fitness - 1))      
    ...
    def Crossover_Flat(self, individuo1, individuo2, taxa_mutacao):
        ...
        while i < self.tam_cromossomo - 1: 
            ...
            valor_escolhido2 = 0
            if menor != maior:
                valor_escolhido1 = uniform(menor, maior)        
                valor_escolhido2 = uniform(menor, maior)             
        ...
        filho1.Funcao_Fitness(cromossomo_decodificado_f1[0], cromossomo_decodificado_f1[1], cromossomo_decodificado_f1[2])
        filho2.Funcao_Fitness(cromossomo_decodificado_f2[0], cromossomo_decodificado_f2[1], cromossomo_decodificado_f2[2])       
